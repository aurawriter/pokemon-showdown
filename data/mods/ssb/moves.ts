...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	*/
	...
	reset: {
		...
		basePower: 0,
		category: "Status",
		desc: "This move acts as Royal Shield for the purpose of Stance Change. The user is protected from most attacks this turn, but not status moves. Reduces the opponent's relevant attacking stat by 1 if they attempt to use a Special or contact move. If the user is Aegislash, changes the user's set from Physical to Special or Special to Physical.",
		shortDesc: "Royal Shield; -1 offense stat on hit; change set.",
		name: "Reset",
		gen: 8,
		pp: 10,
		priority: 4,
	...
	datacorruption: {
		...
		onHit(target, source) {
			...
			const possibleMoves = [
				...
				"irondefense", "ironhead", "royalshield", "knockoff", "lavaplume", "leafblade", "leafstorm", "leechlife",
